...
from .models import Engine, ModuleDef, QuestionDef, RouterRuleDef, VariableDef, VariableRuleDef
    ...
    def _load_engine(self) -> Engine:
        ...
        for path in files:
            ...
            for var in variables_raw:
                ...
                variables.append(VariableDef(name=str(name), var_type=var.get("type"), rules=rules))
