...
const options = [
  {
    ...
    description: 'Select this if your AI is strictly for scientific discovery and development, not intended for commercial placement.',
    icon: 'science',
  },
  {
    value: 2,
...
<template>
  <IntertekLayout
    ...
    module-title="Scope Assessment"
    step-label="Step 1"
    step-total="of 12"
    progress-width="8.33%"
    question-tag="Question 1.1"
    ...
    @next="emit('next')"
  >
    <div role="radiogroup" aria-labelledby="q11-label" class="flex flex-col gap-4">
      <label
      ...
      <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm">
        ...
        <div class="p-6 flex flex-col gap-6">
          <div class="border-b border-slate-100 dark:border-slate-800 pb-4">
            <h4 class="font-black text-slate-900 dark:text-white mb-3 text-xs uppercase tracking-tight">Article 2(6) & 2(8)</h4>
    ...
    <template #tip>
      <div class="flex items-start gap-4 p-5 bg-intertek-yellow/5 border border-intertek-yellow/20">
        ...
        <p class="text-xs text-slate-600 dark:text-slate-400 leading-relaxed font-medium italic">
          Unsure about your product's classification? Consult our <a class="text-intertek-dark dark:text-intertek-yellow font-black underline" href="#">Compliance Guide</a> for detailed definitions.
        </p>
      </div>
    </template>
  </IntertekLayout>
