    ...
    <div role="radiogroup" aria-labelledby="q5-label" class="flex flex-col gap-4">
      ...
      >
        ...
        <div class="flex-1">
          ...
          <p class="text-slate-600 dark:text-slate-400 text-sm leading-relaxed max-w-2xl font-medium">
            {{ opt.description }}
          </p>
        </div>
    ...
    <template #tip>
      <div class="flex items-start gap-4 p-5 bg-intertek-yellow/5 border border-intertek-yellow/20">
        ...
        <p class="text-xs text-slate-600 dark:text-slate-400 leading-relaxed font-medium italic">
          Unsure if your system is a safety component? Consult the
          <a class="text-intertek-dark dark:text-intertek-yellow font-black underline" href="#">Technical Annex I list</a>
