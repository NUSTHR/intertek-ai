...
const options = [
  {
    ...
    description:
      'Governed by Regulation (EU) 2017/745 (MDR). This includes systems intended for diagnosis, prevention, monitoring, or treatment.',
    icon: 'medical_services',
  },
  {
    value: 12,
    title: 'In Vitro Diagnostic Medical Devices',
    description:
      'Governed by Regulation (EU) 2017/746 (IVDR). This includes systems used for examination of specimens derived from the human body.',
    icon: 'biotech',
  },
  {
    value: 0,
    title: 'None of the above',
    description: 'Select this if the system is not classified under Regulation (EU) 2017/745 or Regulation (EU) 2017/746.',
    icon: 'block',
  },
]
</script>
...
<template>
  <IntertekLayout
    ...
    step-label="Step 8"
    step-total="of 15"
    progress-width="53.33%"
    question-tag="Question 5.SPEC_B"
    ...
    @next="emit('next')"
  >
    <div role="radiogroup" aria-labelledby="q5-label" class="flex flex-col gap-4">
      <label
      ...
      <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm">
        ...
        <div class="p-6 flex flex-col gap-6">
          <div class="border-b border-slate-100 dark:border-slate-800 pb-4">
            <h4 class="font-black text-slate-900 dark:text-white mb-3 text-xs uppercase tracking-tight">ANNEX I (11 & 12)</h4>
            <p class="text-xs text-slate-600 dark:text-slate-400 leading-relaxed font-medium">
              References AI systems that are safety components of devices, or are themselves devices, covered by Union
              harmonisation legislation listed in Annex I, Section A.
            </p>
          </div>
          <div class="bg-slate-50 dark:bg-slate-800 p-4 border-l-4 border-intertek-yellow">
            <div class="flex gap-3">
              ...
              <p class="text-[11px] text-slate-700 dark:text-slate-300 font-bold leading-normal italic">
                Medical devices requiring third-party assessment under MDR or IVDR are automatically classified as
    ...
    <template #tip>
      <div class="flex items-start gap-4 p-5 bg-intertek-yellow/5 border border-intertek-yellow/20">
        ...
        <p class="text-xs text-slate-600 dark:text-slate-400 leading-relaxed font-medium italic">
          Unsure about your product's classification? Consult our
          <a class="text-intertek-dark dark:text-intertek-yellow font-black underline" href="#">Compliance Guide</a> for
