...
const ui = computed(() =>
  locale.isZh
    ? {
        ...
        viewFullAct: '查看法规全文。',
        tip: '披露须及时、清晰且可见，除非依法授权的执法用途或内容显然为艺术或讽刺。',
      }
    : {
        ...
        articleDesc:
          'Users of an AI system that generates or manipulates image, audio or video content that constitutes a deep fake shall disclose that the content has been artificially generated or manipulated.',
        infoTip:
          'This obligation does not apply where the use is authorized by law for law enforcement or if the content is part of an obviously artistic, creative or satirical work.',
        viewFullAct: 'View Full Act.',
        tip: 'Disclosure must be timely, clear, and visible, unless the use is legally authorized for law enforcement or the content is clearly artistic or satirical.',
      },
)
    ...
    ? [
        {
          value: true,
          title: '是',
          description: '系统生成高度逼真的内容，可能让合理人误认为真实。',
          icon: 'face_retouching_natural',
        },
        {
          value: false,
          title: '否',
          description: '系统不生成拟真内容，或操纵明显且不具欺骗性。',
