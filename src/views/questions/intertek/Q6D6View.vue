        ...
        <div class="p-6 flex flex-col gap-6">
          <div class="border-b border-slate-100 dark:border-slate-800 pb-4">
            ...
            <p class="text-xs text-slate-600 dark:text-slate-400 leading-relaxed font-medium">
              According to Article 50(4), the labeling obligations for AI-generated content do not apply if the content
              has undergone a process of human review or editorial control and a natural or legal person holds editorial
          ...
          <div class="bg-slate-50 dark:bg-slate-800 p-4 border-l-4 border-intertek-yellow">
            <div class="flex gap-3">
              ...
              <p class="text-[11px] text-slate-700 dark:text-slate-300 font-bold leading-normal italic">
                Editorial responsibility implies accountability for the content's accuracy, legality, and conformity
                with standards.
              </p>
            </div>
          </div>
    ...
    <template #tip>
      <div class="flex items-start gap-4 p-5 bg-intertek-yellow/5 border border-intertek-yellow/20">
        ...
        <p class="text-xs text-slate-600 dark:text-slate-400 leading-relaxed font-medium italic">
          The exemption requires both human oversight and formal responsibility. Consult
          <a class="text-intertek-dark dark:text-intertek-yellow font-black underline" href="#">Article 50 Guidance</a>
          for details.
        </p>
      </div>
    </template>
