    ...
    <div class="max-h-[600px] overflow-y-auto pr-4 custom-scrollbar">
      <div role="radiogroup" aria-labelledby="q5-label" class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        >
          ...
          <div class="flex-1">
            <h3 class="text-sm font-black text-slate-900 dark:text-white uppercase tracking-tight mb-1">{{ opt.title }}</h3>
    ...
    <template #tip>
      <div class="flex items-start gap-4 p-5 bg-intertek-yellow/5 border border-intertek-yellow/20">
        ...
        <p class="text-xs text-slate-600 dark:text-slate-400 leading-relaxed font-medium italic">
          Not sure about these categories? Check the
          <a class="text-intertek-dark dark:text-intertek-yellow font-black underline" href="#">Sector Guide</a> for
