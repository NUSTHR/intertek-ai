    ...
    <template #tip>
      <div class="flex items-start gap-4 p-5 bg-intertek-yellow/5 border border-intertek-yellow/20">
        ...
        <p class="text-xs text-slate-600 dark:text-slate-400 leading-relaxed font-medium italic">
          Questions about GPAI obligations? Consult our <a class="text-intertek-dark dark:text-intertek-yellow font-black underline" href="#">GPAI Technical Guidance</a> for detailed role breakdowns.
        </p>
      </div>
    </template>
  </IntertekLayout>
