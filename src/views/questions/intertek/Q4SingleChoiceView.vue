...
const legalTextMap = computed<Record<string, string>>(() =>
  locale.isZh
    ? {
        'q4.3_b':
          '法规第5(1)(c)(i)条：在与数据最初生成或收集语境无关的社会情境中，对特定自然人或群体给予不利或不当待遇；',
        'q4.3_c':
          '法规第5(1)(c)(ii)条：对特定自然人或群体给予不利或不当待遇，且该待遇对其社会行为或严重性而言不具正当性或不成比例；',
        'q4.4_a':
          '法规第5(1)(d)条：为此特定目的将用于评估或预测自然人犯罪风险的 AI 系统投放市场、投入使用或使用……',
        'q4.4_b':
          '法规第5(1)(d)条：仅基于对自然人的画像或其人格特质评估；该禁令不适用于用于支持人类评估某人是否涉案的 AI 系统，前提是该评估已基于与犯罪活动直接相关的客观可核事实；',
        'q4.5_a':
          '法规第5(1)(e)条：为此特定目的将创建或扩展人脸识别数据库的 AI 系统投放市场、投入使用或使用……',
        'q4.5_b': '法规第5(1)(e)条：通过对互联网或监控视频中的人脸图像进行无差别抓取；',
        'q4.6_a':
          '法规第5(1)(f)条：为此特定目的将用于在工作场所和教育机构推断自然人情绪的 AI 系统投放市场、投入使用或使用……',
        'q4.6_b': '法规第5(1)(f)条：除非该 AI 系统用于医疗或安全目的并拟投放市场或投入使用；',
        'q4.7_a':
          '法规第5(1)(g)条：为此特定目的将基于生物特征数据对自然人进行个体分类的生物特征分类系统投放市场、投入使用或使用……',
        'q4.7_b':
          '法规第5(1)(g)条：以此推断其种族、政治观点、工会成员身份、宗教或哲学信仰、性生活或性取向；',
        'q4.7_c':
          '法规第5(1)(g)条：该禁令不涵盖对依法获得的生物特征数据集（如图像）进行标注或过滤，或在执法领域对生物特征数据进行分类；',
        'q4.8_a': '法规第5(1)(h)条：为执法目的在公共可进入空间使用“实时”远程生物识别系统……',
        'q4.8_b': '法规第5(1)(h)条：用于执法目的，且仅在为下列目标之一具有严格必要性时……',
        'q4.8_c':
          '法规第5(1)(h)(i)-(iii)条：(i) 定向搜寻绑架、贩运或性剥削受害者及失踪人员；(ii) 防止对自然人生命或人身安全的特定、重大且迫在眉睫的威胁，或真实存在或可预见的恐怖袭击威胁；(iii) 定位或识别涉嫌实施法案附件 II 所列犯罪的人员……',
      }
    : {
        'q4.3_b':
