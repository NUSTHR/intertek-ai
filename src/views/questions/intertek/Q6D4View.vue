        ...
        <div class="p-6 flex flex-col gap-6">
          ...
          <template v-else>
            <div class="border-b border-slate-100 dark:border-slate-800 pb-4">
              ...
              <p class="text-xs text-slate-600 dark:text-slate-400 leading-relaxed font-medium">
                Providers of AI systems that generate text which is published with the purpose of informing the public on
                matters of public interest shall ensure that the AI-generated content is clearly labeled or otherwise
                identified as being generated or manipulated by an AI system.
              </p>
            </div>
          </template>
          <div class="bg-slate-50 dark:bg-slate-800 p-4 border-l-4 border-intertek-yellow">
            <div class="flex gap-3">
              ...
              <p class="text-[11px] text-slate-700 dark:text-slate-300 font-bold leading-normal italic">
                This obligation applies regardless of whether the system is high-risk, provided it generates content
    ...
    <template #tip>
      <div class="flex items-start gap-4 p-5 bg-intertek-yellow/5 border border-intertek-yellow/20">
        ...
        <p class="text-xs text-slate-600 dark:text-slate-400 leading-relaxed font-medium italic">
          Public-interest publication triggers transparency labeling duties for AI-generated text under Article 50(4),
          subject to safeguards for rights and freedoms.
        </p>
      </div>
    </template>
  </IntertekLayout>
